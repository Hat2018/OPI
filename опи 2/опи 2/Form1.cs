...
namespace опи_2
{
    public partial class Form1 : Form
    {
        ...
        {
            string myText = textBox1.Text;
            long sizebytes = textBox1.TextLength * sizeof(char) / 1024;
            double countAuthorsPage = textBox1.TextLength / 1800;// авторские страницы
            MessageBox.Show("Статистика по тексту:" + "\n" +
                            "Размер: " + sizebytes + " " + "\n" +
                            "Символы:  " + textBox1.TextLength + "\n" +
        ...
        private void button1_Click(object sender, EventArgs e)// сохранить отредактированиый текст в файл 
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
                File.WriteAllText(sfd.FileName, textBox2.Text); //запись в новый файл
